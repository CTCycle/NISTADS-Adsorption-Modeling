...
from NISTADS.app.src.commons.utils.data.serializer import DataSerializer
from NISTADS.app.src.commons.utils.process.sanitizer import AggregateDatasets
from NISTADS.app.src.commons.constants import PAD_VALUE
...
class InferenceDataLoaderProcessor:
    ...
    def __init__(self, configuration : dict):        
        ...
        _, self.guest_data, self.host_data = serializer.load_adsorption_datasets() 
