...
call pip install keras==3.10.0 scikit-learn==1.6.1 transformers==4.50.3
call pip install numpy==2.1.3 pandas==2.2.3 tqdm==4.67.1 matplotlib==3.10.1 seaborn==0.13.2 
