...
**5) Setup and Maintenance:** allows running some options command such as **Install project into environment** to run the developer model project installation, and **remove logs** to remove all logs saved in *resources/logs*. 
